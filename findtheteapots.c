...
//flagovi za cajnike i parametri za animacije
int teapot1 = 0;
int teapot2 = 0;
int teapot3 = 0;
int teapot4 = 0;
...
static void drawFloorAndWalls(void);
static void drawDisplayCase(void);
static void drawShelf(void);
static void drawTable(void);
static void drawElipsoid(void);
...
void displayFunction(){
    ...
    glPushMatrix();
        drawTeapot1(teapot1, ap1, t1ambient, t1diffuse, t1specular);
    glPopMatrix();

    glPushMatrix();
        drawTeapot2(teapot2, ap2, t2ambient, t2diffuse, t2specular);
    glPopMatrix();

    glPushMatrix();
        drawTeapot3(teapot3, ap3, t3ambient, t3diffuse, t3specular);
    glPopMatrix();

    glPushMatrix();
        drawTeapot4(teapot4, ap4, defaulta, defaultd, defaults);
    glPopMatrix();

    glutSwapBuffers();
}

//funkcija za iscrtavanje poda i zidova
static void drawFloorAndWalls(void){
    glPushMatrix();
...
//funkcija za iscrtavanje vitrine
static void drawDisplayCase(void){
    glPushMatrix();
        ...
        glNormal3f(0.0f, 1.0f, 0.0f);
        glTexCoord2f(1, 0);
        glVertex3f(-1.7f, 0.55f, -0.5f);
        glTexCoord2f(0, 0);
        glVertex3f(-2.7f, 0.55f, -0.5f);
        glTexCoord2f(0, 1);
        glVertex3f(-2.7f, 0.55f, 0.5f);
        glTexCoord2f(1, 1);
        glVertex3f(-1.7f, 0.55f, 0.5f);
...
//funkcija za iscrtavanje police
static void drawShelf(void){
    glPushMatrix();
        glBindTexture(GL_TEXTURE_2D, textureid[0]);
        glBegin(GL_POLYGON);
...
//funkcija za iscrtavanje elipsoida
static void drawElipsoid(void){
    glPushMatrix();
